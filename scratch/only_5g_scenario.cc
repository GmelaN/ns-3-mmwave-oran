 ...
 *
 * You should have received a copy of the GNU General Public License6
...
static ns3::GlobalValue
    g_indicationPeriodicity ("indicationPeriodicity",
                             ...
                             ns3::DoubleValue (2.0), ns3::MakeDoubleChecker<double> (0.01, 2.0));
...
main (int argc, char *argv[])
{
  ...
  NS_LOG_INFO ("Bandwidth " << bandwidth << " centerFrequency " << double (centerFrequency)
                            << " isd " << isd << " numAntennasMmWaveUe " << numAntennasMmWaveUe
                            << " numAntennasMmWave " << numAntennasMmWave);

  // Set the number of antennas in the devices
  // Config::SetDefault ("ns3::MmWaveUeNetDevice::AntennaNum", UintegerValue (numAntennasMmWaveUe));
  ...
  // create mmWave eNB nodes and UE node
